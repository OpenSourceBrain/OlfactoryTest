...
projFile = File(os.getcwd(), "../OlfactoryTest.ncx")
...
simConfigs.append("AllSimulators")
...
spike_times = []
mep_file = open('../../NEURON/.test.grc.mep')
...
def testAll(argv=None):
    ...
    spikeTimesToCheck = {'CG_GC_0': spike_times}
    
    
    spikeTimeAccuracy = 0.2 # ms in 300 ms
